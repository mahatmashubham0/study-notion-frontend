...
import ProfileDropDown from "../design/Auth/ProfileDropDown";
...
const Navbar = () => {
  ...
  const getAllCategorisOfNavbar = async () => {
    try {
      ...
      setSubLinks(result.data.SuccessResponse.data);
      toast(result.data.SuccessResponse.message)
  ...
  return (
    <div className=" flex h-14 items-center justify-center border-b-[1px] border-b-richblack-600 ">
      {/* w-11/12 it means it take 100vh ka 90% but when use use max-w-maxContent ka 90%*/}
              ...
              <div key={index}>
                {
                  ...
                  element.title === "Catalog" ? (
                    <div className="group relative">
                      <Link className="text-richblack-25 flex flex-row items-center justify-center gap-1">
                        {element.title}
